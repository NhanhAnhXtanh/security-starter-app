...
import com.react.spring.catalog.service.TagService;
...
public class TagController {
    ...
    public TagDto create(@Valid @RequestBody TagRequest req) {
        return service.create(req);
    }

    @PutMapping("/{id}")
    public TagDto update(@PathVariable UUID id, @Valid @RequestBody TagRequest req) {
